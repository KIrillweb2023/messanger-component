...
<form action="#" method="POST" enctype="multipart/form-data" autocomplete="off" class="main__wrapper__registr__add">
    <div class="main__wrapper__registr__add-input name">
        ...
        <input type="text" name="fname" id="name" placeholder="Снежана" class="main__wrapper__registr__add-input__input">
    </div>
    <div class="main__wrapper__registr__add-input email">
        ...
        <input type="text" name="email" id="email-reg" placeholder="Snezok04@mail.ru" class="main__wrapper__registr__add-input__input">
    </div>
    <div class="main__wrapper__registr__add-input password">
        ...
        <input type="password" name="password" id="password-reg"  placeholder="****ok_love" class="main__wrapper__registr__add-input__input">
    </div>
